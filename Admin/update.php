<?php
    ...
    if(isset($_POST['bbsubmit'])){
        ...
        $sql = "UPDATE `banner` SET `bn1`='$bimg'";
   ...
   if(isset($_POST['asubmit'])){
    ...
    $aqry = "UPDATE `about` SET `a1`='$a1img'";
...
if(isset($_POST['ssubmit'])){
    ...
    $aqry = "UPDATE `tourplace` SET `tp1`='$tp1img',`tp2`='$tp2img',`tp3`='$tp3img'";
    $aresult = mysqli_query($con,$aqry);
...
if(isset($_POST['esubmit'])){
    ...
    $eventqry = "UPDATE `event` SET `eimg1`='$eimg1',`eimg2`='$eimg2',`eimg3`='$eimg3'";
...
if(isset($_POST['blsubmit'])){
    ...
    $blinsert = "UPDATE `blog` SET `blimg1`='$blimg1',`blimg2`='$blimg2',`$blimg3`='[value-4]',`blimg4`='$blimg4'";
...
if(isset($_POST['vhsubmit'])){
    ...
    $vhinsert = "UPDATE `service` SET `vh1`='$vh1img',`vh2`='$vh2img',`vh3`='$vh3img',`vh4`='$vh4img'";
...
if(isset($_POST['hsubmit'])){
    ...
    $hsql = "UPDATE `hservice` SET `hs1`='$h1img',`hs2`='$h2img',`hs3`='$h3img'";
